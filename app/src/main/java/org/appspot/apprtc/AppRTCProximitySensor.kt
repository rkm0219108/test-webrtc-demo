 ...
 */
class AppRTCProximitySensor private constructor(context: Context, private val onSensorStateListener: Runnable?) : SensorEventListener {
    ...
    private var lastStateReportIsNear: Boolean = false
