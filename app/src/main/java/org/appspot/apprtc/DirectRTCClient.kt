 ...
 * connections.
 */
class DirectRTCClient(private val events: AppRTCClient.SignalingEvents) : AppRTCClient, TCPChannelClient.TCPChannelEvents {
    ...
    private fun connectToRoomInternal() {
        ...
        val endpoint = parameters.roomId
    ...
    companion object {
        ...
        internal val IP_PATTERN = Pattern.compile("("
                // IPv4
                + "((\\d+\\.){3}\\d+)|"
                // IPv6
